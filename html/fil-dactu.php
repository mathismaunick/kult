...
$url="https://api.themoviedb.org/3/movie/now_playing?api_key=f28b73c15bf2d40ebce39e45e931d32e&language=fr-FR&page=1&region=FR";

$json_response = file_get_contents($url);

$object_response = json_decode($json_response, true);

$size = count($object_response["results"]);
